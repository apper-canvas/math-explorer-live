...
function Division() {
  ...
  if (loading) {
    return (
      <div className="min-h-full bg-gradient-to-br from-secondary/5 via-white to-secondary/10 flex items-center justify-center">
        <div className="text-center">
          <div className="w-16 h-16 bg-secondary rounded-full flex items-center justify-center mb-4 animate-bounce">
            <ApperIcon name="Divide" className="w-8 h-8 text-white" />
          </div>
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 bg-gradient-to-br from-secondary to-secondary/80 rounded-xl flex items-center justify-center">
                  <ApperIcon name="Divide" className="w-6 h-6 text-white" />
                </div>
                <div>
                  <h1 className="text-2xl font-display text-surface-800">Division Practice</h1>
                  <p className="text-surface-600">Learn to share and group numbers</p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-6">
                ...
                <div className="flex items-center space-x-4 text-sm">
                  <div className="text-center">
                    <div className="font-display text-lg text-secondary">{sessionStats.correct}</div>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
              ...
              <div className="text-center">
                  ...
                  <input
                    ...
                    className={`w-32 h-16 text-4xl font-display text-center border-2 rounded-xl transition-all ${
                      showFeedback
                        ...
                        : 'border-surface-300 focus:border-secondary focus:outline-none'
                    }`}
                  />
                </div>
                  ...
                  {showFeedback && (
                    ...
                    >
                      ...
                      <span className="font-medium">
                        {isCorrect ? "Perfect!" : `Correct answer: ${currentProblem?.answer}`}
                      </span>
                    </motion.div>
                  )}
                </AnimatePresence>
                ...
                {!showFeedback && (
                  <motion.button
                    ...
                    onClick={checkAnswer}
                    disabled={!userAnswer}
                    className="px-8 py-3 bg-secondary text-white rounded-xl font-medium shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Check Answer
                  </motion.button>
                )}
          ...
          >
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-surface-200 p-6">
              <h3 className="font-semibold text-surface-800 mb-4">Division Facts</h3>
              <div className="space-y-3 text-sm text-surface-600">
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-secondary rounded-full"></div>
                  <span>Division is sharing equally into groups</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-secondary rounded-full"></div>
                  <span>The answer tells us how many in each group</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-secondary rounded-full"></div>
                  <span>Division is the opposite of multiplication</span>
                </div>
                {currentProblem && (
